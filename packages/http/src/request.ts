...
/**
 * Perform an Http request through the local proxy started by the wallet's
 * dev-with-proxy script. The proxy performs the upstream request from Node,
 * where browser CORS restrictions do not apply.
 */
export const requestViaLocalProxy = async (
  options: HttpOptions,
