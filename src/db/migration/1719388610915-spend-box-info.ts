...
export class SpendBoxInfo1719388610915 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const queries = [
      'CREATE TABLE "box_spend" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "network_type" text NOT NULL, "box_id" text NOT NULL, "spend_tx_id" text NOT NULL, "spend_index" integer NOT NULL, "spend_height" integer NOT NULL, "spend_timestamp" integer NOT NULL, CONSTRAINT "box_id_for_network" UNIQUE ("network_type", "box_id"))',
