                ...
                <React.Fragment>
                    <Typography>
                        ...
                        <span style={{letterSpacing: 8, display: "block", padding: 10}}>
                            <span style={{background: "#CDCDCD", padding: 5, fontWeight: "bold", fontSize: 20, borderRadius: 10}}>
                                {props.display}
                            </span>
                        </span>
                        <br/>
                    ...
                    <Button variant="contained" onClick={props.confirm}>Confirm</Button>
                </React.Fragment>
            ) : props.id ? (
                <React.Fragment>
                    <Typography>
                        ...
                        <br/>
                        Goto <b>DApps <span style={{fontSize: "200%"}}>→</span> DApp Connector</b>
                        <br/>
