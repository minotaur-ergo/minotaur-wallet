...
const get_extended_public_key_base64_or_hex_to_base58 = (extended_public_key: string, encoding: "base64" | "hex" = "base64") => {
    try {
...
const get_base58_extended_public_key = (extended_public_key: string) => {
    if(is_valid_extended_public_key_base58(extended_public_key)) return extended_public_key
    const fromBase64 = get_extended_public_key_base64_or_hex_to_base58(extended_public_key, "base64")
    if(fromBase64) return fromBase64
    return get_extended_public_key_base64_or_hex_to_base58(extended_public_key, "hex")
}
