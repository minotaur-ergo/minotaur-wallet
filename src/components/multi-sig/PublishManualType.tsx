    ...
    return (
        <Grid item xs={12} marginTop={2}>
            <ToggleButtonGroup
                ...
                exclusive
                onChange={(event, newType) => props.setPublishType(newType as PUBLISH_MANUAL_TYPES)}
            >
                <ToggleButton style={{ width: `${50}%` }} value={PUBLISH_MANUAL_TYPES.clipboard}>
                    ClipBoard
                </ToggleButton>
                <ToggleButton style={{ width: `${50}%` }} value={PUBLISH_MANUAL_TYPES.qrcode}>
                    QrCode
                </ToggleButton>
            </ToggleButtonGroup>
        </Grid>
