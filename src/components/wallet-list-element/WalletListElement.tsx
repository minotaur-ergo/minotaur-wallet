...
import { Avatar, Badge, CircularProgress, ListItem, ListItemAvatar, ListItemText } from "@mui/material";
    ...
    return (
        <ListItem onClick={gotoWallet}>
            <ListItemAvatar style={{ position: "relative" }}>
                <Avatar
                    sx={network_type.color === "orange" ? { bgColor: deepOrange[500] } : network_type.color === "purple" ? { bgColor: deepPurple[500] } : {}}>
