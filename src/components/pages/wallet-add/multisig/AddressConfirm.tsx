  ...
  useEffect(() => {
    ...
    if (wallets && wallets.length > 0) {
      ...
      try {
        ...
        setError('Invalid extended public key entered');
      }
    }
  });
  return (
        ...
        {error ? (
          <Grid item xs={12} marginBottom={2}>
            <Typography color={'red'}>
              Invalid parameter entered. Please go back and fix errors.
            </Typography>
          </Grid>
        ) : (
          <Grid item xs={12} marginBottom={2}>
            ...
            <Typography>
              Please check it. if this is not your address you entered mnemonic
              or mnemonic passphrase wrong. double check it and try again
            </Typography>
            <div>
              <CopyableAddress address={address} />
            </div>
            <Typography>
              This is a multi-signature wallet. In order to send funds from it
              you need at least
