...
class WalletCreate extends React.Component<WalletCreatePropsType, WalletCreateStateType> {
    ...
    goConfirm = (mnemonic: string, mnemonic_passphrase: string) => {
        this.setState({mnemonic: mnemonic, step: 2, mnemonic_passphrase: mnemonic_passphrase});
    };
    ...
    renderPassword = () => (
        <WalletPassword
            ...
            goBack={() => this.goConfirm(this.state.mnemonic, this.state.mnemonic_passphrase)}
        />)
