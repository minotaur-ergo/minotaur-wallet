        ...
        <Grid container spacing={2}>
            <Grid item xs={12}>
                ...
                <Typography style={{color: "#777"}}>
                    Cool wallet is designed for more security.
                    It is usually created on a device that is not connected to the Internet.
                    Next to it, a read-only wallet is created on an internet-connected device.
                    You create your transactions using a read-only wallet and then sign it using a cold wallet.
                    Note that if this wallet is connected to the Internet, the boxes will not be updated for it.
                </Typography>
            </Grid>
        </Grid>
    );
