...
const Mnemonic = (props: PropsType) => {
    ...
    const initialMnemonic = props.mnemonic ? props.mnemonic : bip39.generateMnemonic(160);
    ...
    return (
        <Container>
            <Grid container spacing={2} marginBottom={2}>
                ...
                <Grid item xs={12}>
                    <p>
                        this is your mnemonic for your ergo wallet.
                        with these words you can restore your wallet on any other device.
                        write words on a paper and store it in a safe and secure place
                    </p>
                </Grid>
                <InAdvancedMode>
                    <Grid item xs={12}>
                        <MnemonicWordLength value={mnemonicWordSize} setValue={setMnemonicWordCount}/>
                    </Grid>
                </InAdvancedMode>
